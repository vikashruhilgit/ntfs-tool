...
struct Ntfsctl: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        discussion: """
            ...
            """,
        version: "0.1.0",
        subcommands: [Info.self, List.self, Verify.self, Cat.self, Dump.self, Create.self, Delete.self, Write.self, Truncate.self, SetDirty.self, Cp.self, Rm.self, Mv.self, Scan.self, ReclaimOrphans.self, Mkntfs.self]
    )
}
