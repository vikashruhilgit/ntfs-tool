...
|---|---|---|
| **Unit tests** (`swift test`) | All NTFSCore parsers + write paths against fixtures | ✅ 133/133 passing (incl. extension-record classifier) |
