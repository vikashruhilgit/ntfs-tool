...
|---|---|---|
| **Unit tests** (`swift test`) | All NTFSCore parsers + write paths against fixtures | ✅ 143 tests, 0 failures (1 skip: two concurrent migrations don't fit the 4 MiB fixture); incl. extension-record classifier + `$ATTRIBUTE_LIST`-aware delete |
